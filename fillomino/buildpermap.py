...
def build_cooling_permap(datafile="resources/manufacturer-data-cooling.txt"):
    ...
    col_headers = [
        (Tdbr, Twbr, P) for Tdbr, Twbr in r.to_numpy().T
...
def build_heating_permap(datafile="resources/manufacturer-data-heating.txt"):
